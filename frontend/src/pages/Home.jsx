...
const Home = () => {
  ...
  const createProj = (e) => {
    ...
    if (projTitle === "") {
      ...
      fetch(`${api_base_url}/projects/createProject`, {  // Updated API path to match backend
        mode: "cors",
        method: "POST",
        headers: {
  ...
  const getProj = () => {
    fetch(`${api_base_url}/projects/getProjects`, {  // Updated API path to match backend
      mode: "cors",
      method: "POST",
      headers: {
        "Content-Type": "application/json",
  ...
  useEffect(() => {
    getProj(); // Fetch projects on component mount
  }, []);
  ...
  // Fetch user details
  useEffect(() => {
    fetch(`${api_base_url}/users/getUserDetails`, {  // Assuming this is a valid endpoint
      mode: "cors",
      method: "POST",
      headers: {
        "Content-Type": "application/json",
